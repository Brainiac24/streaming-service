      ...
      <td align="center" valign="top" class="em_aside5"><table align="center" width="650" border="0" cellspacing="0" cellpadding="0" class="em_main_table" style="width:650px; table-layout:fixed;">
          <tr>
            <td align="center" valign="top" style="padding:0 25px; background-color:#ffffff;" class="em_aside10"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <tr>
                <td class="em_blue em_font_22" align="center" valign="top" style="font-family: Raleway, Arial, sans-serif; font-size: 24px; line-height: 29px; color:#333; font-weight:bold;">Восстановление пароля</td>
              </tr>
              <tr>
                <td height="14" style="height:14px; font-size:0px; line-height:0px;">&nbsp;</td>
              </tr>
              <tr>
                <td class="em_grey" align="center" valign="top" style="font-family: Raleway, Arial, sans-serif; font-size: 16px; line-height: 26px; color:#434343; font-weight:normal;">
                    Чтобы восстановить ваш пароль нажмите на кнопку ниже <br>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td align="center" valign="top"><table width="250" style="width:250px; background-color:#1e87f0; border-radius:4px;" border="0" cellspacing="0" cellpadding="0" align="center">
                  <tr>
                    <td class="em_white" height="42" align="center" valign="middle" style="font-family: Raleway, Arial, sans-serif; font-size: 16px; color:#ffffff; font-weight:bold; height:42px;"><a href="{{url('/api/v1/auth/password/reset/confirm/')}}?authKey={{$authkey}}" target="_blank" style="text-decoration:none; color:#ffffff; line-height:42px; display:block;">СБРОСИТЬ ПАРОЛЬ</a></td>
                  </tr>
                </table>
                </td>
              </tr>
              ...
              <tr>
                <td class="em_grey" align="center" valign="top" style="font-family: Raleway, Arial, sans-serif; font-size: 16px; line-height: 26px; color:#434343; font-weight:normal;">
                    Ссылка действует в течении 12 часов <br>
                    Если Вы не запрашивали восстановление пароля просто проигнорируйте это письмо.</td>
              </tr>
              <tr>
      ...
      <td align="center" valign="top"><table align="center" width="650" border="0" cellspacing="0" cellpadding="0" class="em_main_table" style="width:650px; table-layout:fixed;">
          <tr>
            <td align="center" valign="top" style="padding:0 25px;" class="em_aside10"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <tr>
                <td align="center" valign="top" style="font-family: Raleway, Arial, sans-serif; font-size: 16px; line-height: 26px; color:#434343; font-weight:normal;">&copy; Example 2021</td>
              </tr>
              <tr>
                <td height="16" style="font-size:0px; line-height:0px; height:16px;">&nbsp;</td>
              </tr>
