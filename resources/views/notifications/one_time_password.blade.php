      ...
      <td align="center" valign="top" class="em_aside5"><table align="center" width="650" border="0" cellspacing="0" cellpadding="0" class="em_main_table" style="width:650px; table-layout:fixed;">
          <tr>
            <td align="center" valign="top" style="padding:0 25px; background-color:#ffffff;" class="em_aside10"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <tr>
                <td class="em_blue em_font_22" align="center" valign="top" style="font-family: Raleway, Arial, sans-serif; font-size: 24px; line-height: 29px; color:#333; font-weight:bold;">Код входа на Example</td>
              </tr>
              <tr>
              ...
              <tr>
                <td class="em_grey" align="center" valign="top" style="font-family: Arial, sans-serif; font-size: 16px; line-height: 26px; color:#434343; font-weight:normal;">
                    Для входа введите указанный ниже код<br>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td align="center" valign="top"><table width="250" style="width:250px; cellspacing="0" cellpadding="0" align="center">
                  <tr>
                    <td class="em_white" height="42" align="center" valign="middle" style="font-family: Raleway, Arial, sans-serif; font-size: 16px; font-weight:bold; height:42px;">
                        <div style="line-height:60px; display:block; font-size:46px">{{$otp_token}}</div>
                    </td>
                  </tr>
                </table>
                </td>
              ...
              <tr>
                <td class="em_grey" align="center" valign="top" style="font-family: Arial, sans-serif; font-size: 16px; line-height: 26px; color:#434343; font-weight:normal;">
                    Код действует в течении {{((int)config('auth.otp_send_timeout_minute') / 60 )}} часа <br>
              </tr>
              <tr>
      ...
      <td align="center" valign="top"><table align="center" width="650" border="0" cellspacing="0" cellpadding="0" class="em_main_table" style="width:650px; table-layout:fixed;">
          <tr>
            <td align="center" valign="top" style="padding:0 25px;" class="em_aside10"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <tr>
                <td align="center" valign="top" style="font-family: Arial, sans-serif; font-size: 16px; line-height: 26px; color:#434343; font-weight:normal;">&copy; Example 2023</td>
              </tr>
              <tr>
                <td height="16" style="font-size:0px; line-height:0px; height:16px;">&nbsp;</td>
              </tr>
