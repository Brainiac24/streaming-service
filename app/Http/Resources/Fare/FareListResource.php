...
class FareListResource extends BaseJsonResource
{
    public $fares;
    public function __construct($fares, $currentFare = null)
    {
        ...
        foreach ($fares as $fare) {
            ...
            if ($fare->fare_type_id == FareTypes::EXTRA) {
                array_push($extraFares, $fareItem);
            } else {
        ...
        $this->data = [
            'extra_stream' => $extraFares,
            'stream_fares' => $defaultFares,
        ];
    }
}
