...
class CacheUserProvider implements UserProvider
{
    ...
    public function retrieveById($identifier)
    {
        ...
        return CacheServiceFacade::remember(CacheKeys::userIdKey($identifier), config('cache.ttl'), function () use ($model, $identifier) {
    ...
    public function retrieveByCredentials(array $credentials)
    {
        ...
        return CacheServiceFacade::remember(CacheKeys::userEmailKey($credentials['email']), config('cache.ttl'), function () use ($credentials) {
